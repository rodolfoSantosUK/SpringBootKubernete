...
import com.dailycodeBuffer.Srvc.model.PaymentMode;
...
class OrderServiceImplTest {
    ...
    void test_When_Order_Success() {
        ...
        //Actual
        OrderResponse orderResponse = orderService.getOrderDetails(anyLong());
    ...
    private OrderRequest getMockOrderRequest() {
        return OrderRequest.builder()
                .productId(1l)
                .quantity(10l)
                .paymentMode(com.dailycodeBuffer.orderSrvc.model.PaymentMode.CASH)
                .totalAmount(100l)
                .build();
    }
